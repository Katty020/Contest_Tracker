  ...
  useEffect(() => {
    const fetchContests = async () => {
      try {
        ...
        // Filter only Codeforces contests
        const codeforcesContests = data.filter((contest: Contest) => contest.platform === "codeforces")
        ...
        if (bookmarked) {
          ...
          setContests(
            codeforcesContests.map((contest: Contest) => ({
              ...contest,
                ...
                <Card key={contest.id} className="overflow-hidden">
                  <CardHeader className="pb-2">
                    <div className="flex justify-between items-start">
                      <Badge className="bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300 capitalize">
                        Codeforces
                      </Badge>
                      <Button
                        variant="ghost"
